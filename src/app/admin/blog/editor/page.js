        ...
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-5 flex flex-col gap-3">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            <input
              ...
              placeholder="SEO 제목 (선택, 비우면 글 제목 사용)"
              className="w-full text-sm bg-gray-50 border border-gray-100 rounded-2xl px-4 py-3 text-gray-700 placeholder-gray-300"
            />
            <input
              type="text"
              value={seoDescription}
              onChange={(e) => setSeoDescription(e.target.value)}
              placeholder="SEO 설명 (선택, 비우면 요약 설명 사용)"
              className="w-full text-sm bg-gray-50 border border-gray-100 rounded-2xl px-4 py-3 text-gray-700 placeholder-gray-300"
            />
          </div>
        </div>
